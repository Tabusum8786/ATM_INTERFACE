...
class Account {
    ...
    public void withdraw() {
        ...
        if (details_balance.get(check_userId) != null && amount <= details_balance.get(check_userId)) {
            ...
            String his = amount + "   has withdrawn from your account\n";
    ...
    public void deposit() {
        ...
        int amount = sc.nextInt();
        String his = amount + "   has deposited to your account..\n";
    ...
    public void transfer() {
        ...
        if (transferAmount <= details_balance.get(check_userId) && details_balance.get(check_userId) != null) {
            ...
            String his = transferAmount + "  has transferred from your account..\n";
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            while (true) {
                ...
                while (exit) {
                    ...
                    switch (ch) {
                        case 1 -> my_acc.transac_history();
                        case 2 -> my_acc.withdraw();
                        case 3 -> my_acc.deposit();
                        case 4 -> my_acc.transfer();
                        default -> {
                            exit = false;
                            System.out.println("Thank you for visiting..!");
                        }
